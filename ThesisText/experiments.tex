...
Trees and Bayesian Networks are used.~\TODO{Citation is needed on claim that
Trees and BNets are good for nominal data}
...
\TODO{These values are the same for every variant of the dataset. This needs to be explained}
